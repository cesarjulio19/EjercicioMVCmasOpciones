...
<body style="position : absolute;">
    <form action="<?php echo constant('URL') . 'registro/anadirUsu' ?>" method="post">
       ...
       <div class="mb-3" style = " width: 500px">
         <input type="text" class="form-control" id="nombre" placeholder="Nombre" maxlength="30" name="nombre" value = "<?php echo $this->nombre?>">
       </div>

       <div class="mb-3" style = " width: 500px">
         <input type="text" class="form-control" id="apellido" placeholder="Apellidos" maxlength="69" name="apellido" value = "<?php echo $this->apellido?>">
       </div>

       <div class="mb-3" style = " width: 500px">
         <input type="email" class="form-control" id="email" placeholder="Email" maxlength="50" name="email" value = "<?php echo $this->email?>">
       </div>

       <div class="mb-3" style = " width: 500px">
         <input type="text" class="form-control" id="usuario" placeholder="Nombre de usuario" maxlength="10" name="usuario" value = "<?php echo $this->usuario?>">
       </div>
    ...
    <p style="color: red; margin-left: 500px"><?php echo $this->error?></p>
